...
<div align="left" id="block">
	...
	<spring:message code="action.appreciate_photo" />
	<a href="/photo/${post.estimation.photo.id}"> <img alt=""
		width="20%" height="20%"
		src="/resources/selfshots/${post.estimation.photo.user.login}/${post.estimation.photo.title}" /></a>
	<br />
	<div align="right">
