...
(function() {
							...
							.each(
									...
									function(i, elem) {
										...
										if (typeof elem === "string") {
											...
											// Trim whitespace, otherwise
											// indexOf won't work as expected
											...
											// Remove IE's autoinserted <tbody>
	...
	(function() {
		...
		var posProcess = function(selector, context) {
			var tmpSet = [], later = "", match, root = context.nodeType ? [ context ]
					: context;
							...
							.each(
									...
									function(index, type) {
										...
										if (events[type]) {
											...
											// remove generic event handler if
	...
	jQuery.each([ 'Left', 'Top' ], function(i, name) {
		...
		jQuery.fn[method] = function(val) {
			...
			this.each(function() {
				this == window || this == document ? window.scrollTo(!i ? val
						: jQuery(window).scrollLeft(), i ? val : jQuery(window)
						.scrollTop()) : this[method] = val;
			}) :
