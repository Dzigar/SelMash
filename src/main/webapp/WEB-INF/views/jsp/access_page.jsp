...
<body>
	<div id="wrapper">
				...
				<td align="right"><div class="login-form" align="right">
						<form id="login-form" name="login-form"
							...
							<input type="text" class="input username" name="j_username"
								id="j_username" placeholder="Username" /> <input
								type="password" class="input password" placeholder="Password"
		...
		<div class="reg-form">
						...
						<td><form:form action="/register" commandName="user"
								...
								<ul>
									...
									<li><input type="text" name="lastname"
										class="input surname" placeholder="Lastname" required /></li>
									...
									<li><input type="text" name="login" type="text"
										class="input login" placeholder="Login" required /></li>
									<li><form:errors path="password" cssClass="error" /></li>
									<li><input type="password" name="password" type="password"
										class="input password" placeholder="Password" required /></li>
			...
			<div class="footer" align="center">SelfMash 2014</div>
		</div>
	</div>
